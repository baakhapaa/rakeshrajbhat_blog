...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-3xl font-serif font-bold text-white">Add Project</h1>
    </div>
    ...
    <div class="bg-[#1a1f26] rounded-xl border border-white/5 p-6">
        <form action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label for="image" class="block text-gray-300 text-sm font-medium mb-2">Project Image *</label>
                    ...
                    <p class="text-xs text-gray-400 mt-1">Upload a square image (recommended: 200x200px)</p>
                    @error('image')
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="4"
                        class="w-full px-4 py-2 bg-[#0b0e12] border border-white/10 rounded-lg text-gray-200 placeholder:text-gray-500 focus:border-[#D4AF37] focus:outline-none transition"
                        placeholder="Detailed description that will appear in the popup...">{{ old('description') }}</textarea>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="color" id="color" name="color" value="{{ old('color', '#D4AF37') }}"
