...
<section class="min-h-screen bg-[#f8f6f0] pt-32 pb-20 text-[#1e1e1a]">
    <article class="max-w-3xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        <div class="space-y-8 text-[#3a3a34] leading-7">
            ...
            <section><h2 class="text-2xl font-serif font-bold text-[#1e1e1a] mb-3">Newsletter subscriptions</h2><p>If you subscribe to the newsletter, we collect your email address and consent timestamp. We send a confirmation email before adding you to the mailing list. You can unsubscribe or request deletion at any time through the <a href="{{ route('contact') }}" class="text-[#735A12] underline">Contact page</a>.</p></section>
